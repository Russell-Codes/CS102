...
public class GameManager {
    ...
    public String createGame(Game game) {
        // Enforce maximum lobby capacity to prevent memory overload
        if (games.size() >= MAX_LOBBIES) {
            logger.warn("Maximum lobby capacity reached. Cannot create new room.");
            return null;
        }

        // Generated by Claude Haiku 4.5; generate a unique 6-character room ID
    ...
    public void sweepSlowPlayers() {
        // Created with the help of Gemini 3.1 Flash; modified to fit our specific use
        // case of broadcasting refreshes for inactive players.
    ...
    public void cleanupIdleRooms() {
        // Created with the help of Gemini 3.1 Flash; modified to fit our specific use
        // case of removing rooms that have been idle for too long.
        long now = System.currentTimeMillis();
